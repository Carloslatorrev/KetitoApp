...
public class SatisfaccionEstrellaGenerator {
    ...
    public void init(Context context, ViewGroup root){
        ...
        View view = inflater.inflate(R.layout.partial_encuesta_satisfaccionestrella, root, true);
        title = view.findViewById(R.id.satisfaccionEstrellaTitle);
        txtDescription= view.findViewById(R.id.satisfaccionEstrellaDescription);
        radioGroup = view.findViewById(R.id.satisfaccionEstrellaRadioGroup);
        radioButton1 = view.findViewById(R.id.satisfaccionEstrellaRadio1);
        radioButton2 = view.findViewById(R.id.satisfaccionEstrellaRadio2);
        radioButton3 = view.findViewById(R.id.satisfaccionEstrellaRadio3);
        radioButton4 = view.findViewById(R.id.satisfaccionEstrellaRadio4);
        radioButton5 = view.findViewById(R.id.satisfaccionEstrellaRadio5);
        txtMinimo = view.findViewById(R.id.txtSatisfaccionEstrellaMinimo);
        txtMaximo = view.findViewById(R.id.txtNotaSatisfaccionEstrellaMaximo);
